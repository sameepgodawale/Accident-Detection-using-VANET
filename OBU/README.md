...
| MPU9250        | Secondary accel + gyro     | I2C2 PB10/PB3   |
...
### I2C2 — Wire2  (PB10 = SCL,  PB3 = SDA)  — isolated bus
MPU9250 alone here to avoid 0x68 clash with DS3231 on I2C1.
4.7kΩ pull-up from PB10 → 3.3V and from PB3 → 3.3V.
Note: PB11 is not broken out on the Black Pill board.
...
| PB3  | I2C2 SDA            | MPU9250 (isolated bus)    |
