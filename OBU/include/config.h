...
//    DS3231   0x68  fixed
//
//  I2C2 (Wire2)  PB10=SCL  PB3=SDA   ← isolated, avoids 0x68 clash with RTC
//    Note: PB11 not broken out on Black Pill — use PB3 for I2C2 SDA instead
...
#define IMU2_SCL_PIN           PB10   // I2C2 SCL
#define IMU2_SDA_PIN           PB3    // I2C2 SDA — PB11 not broken out on Black Pill
...
// ── Vehicle Identity ─────────────────────────────────────────────────────────
// ★ Change this to the actual vehicle number plate before flashing ★
// Format: use the registration number exactly as printed on the plate.
// This is included in every EAM so the CMS knows which vehicle was involved.
#define VEHICLE_ID             "MH01AB1234"
